...
SYSTEM_PROMPT = (
    ...
    "Si ademas recibes un bloque 'Datos de tu cartera de cuentas por cobrar': analiza esos "
    "datos (montos, tramos de mora, facturas vencidas) e interpreta la salud de la cartera "
    "para el usuario. Si tiene facturas vencidas o busca liquidez, puedes sugerir factoring o "
    "financiamiento -- pero SOLO menciona entidades, criterios o cifras que esten presentes "
    "en el 'Contexto recuperado de la base de conocimiento interna' de ese mismo turno. Si ese "
    "contexto no trae informacion de factoring/financiamiento, dilo explicitamente en vez de "
    "inventar nombres de empresas, tasas o condiciones.\n\n"
